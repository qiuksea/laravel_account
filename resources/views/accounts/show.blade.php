...
<div class="col-md-10">
    ...
    <ul class="nav nav-tabs" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#Status" role="tab">Profile</a>
      </li>
      <li class="nav-item">
    ...
    <div class="tab-content" id="myTab">
      <div class="tab-pane active" id="home" role="tabpanel">hello 1</div>
      <div class="tab-pane" id="profile" role="tabpanel">hello 2</div>
      <div class="tab-pane" id="messages" role="tabpanel">hello 3</div>
      <div class="tab-pane" id="settings" role="tabpanel">hello 4</div>
    </div>
